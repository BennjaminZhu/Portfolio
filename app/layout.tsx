...
export const metadata: Metadata = {
  title: "Benjamin Zhu — Data & Business Analytics",
  description:
    "Data analytics portfolio of Benjamin Zhu — ML pipelines, causal inference, predictive modeling, and decision-ready recommendations.",
};
